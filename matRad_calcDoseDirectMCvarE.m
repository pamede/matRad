function resultGUI = matRad_calcDoseDirectMCvarE(optMode, optParameters, ct,stf,pln,cst,w,nHistories)
...
if strcmp(pln.radiationMode,'protons')
    ...
    switch pln.propMC.proton_engine
        case 'MCsquare'
        dij = matRad_calcParticleDoseMCsquareVarE(optMode, optParameters, ct,stf,pln,cst,nHistories,calcDoseDirect);
        case 'TOPAS'
